  ...
  return (
    <section className="footer page-body__footer">
      <div className="footer__container">
        ...
        <div className="footer__mobile-phone">
          <a className="footer__mobile-phone-link" href="tel:*0904">
            <svg className="footer__mobile-phone-icon" width="10" height="16" viewBox="0 0 10 16" fill="none">
            ...
            <p className="footer__mobile-phone-number">
              *0904
            </p>
          </a>
        ...
        <div className="footer__urban-phone">
          <a className="footer__urban-phone-link" href="tel:88001112233">
            <svg className="footer__urban-phone-icon" width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <p className="footer__urban-phone-number">
              8&nbsp;800&nbsp;111&nbsp;22&nbsp;33
            </p>
          </a>
          <p className="footer__text">
        ...
        <ul className="footer__social">
          <li className="footer__social-item">
            <a href="" className="footer__social-link">
              <svg className="footer__social-link-icon" width="9" height="16" viewBox="0 0 9 16" fill="none">
          ...
          <li className="footer__social-item">
            <a href="" className="footer__social-link">
              <svg className="footer__social-link-icon" width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <li className="footer__social-item">
            <a href="" className="footer__social-link">
              <svg className="footer__social-link-icon" width="16" height="13" viewBox="0 0 16 13" fill="none">
