...
const UserBlock = () => {
  ...
  return (
    <div className="user-block header__user-block">
      <a href="" className="user-block__link">
        <svg className="user-block__icon" width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="user-block__span">
